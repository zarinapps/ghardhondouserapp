...
class _ProjectMetaDetailsState extends CloudState<ProjectMetaDetails> {
  ...
  late ProjectModel? project =
      projectDetails['project'] is Map
          ? ProjectModel.fromMap(
            projectDetails['project'] as Map<String, dynamic>,
          )
              ...
              onPressed: () {
                ...
                final metaImageData =
                    metaImage?.value != metaImageUrl &&
                            metaImage?.value != '' &&
                            metaImage != null
                        ? <String, dynamic>{'meta_image': metaImage}
                        : null;
                data
  ...
  Widget height([double? h]) {
    return SizedBox(height: h?.rh(context) ?? 15.rh(context));
  }
}

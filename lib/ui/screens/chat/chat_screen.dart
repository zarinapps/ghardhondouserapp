...
//                     await _onTapDeleteAllMessages();
//                   case 'blockUser':
//                     await _onTapBlockUser();
//                   case 'unblockUser':
//                     await _onTapUnblockUser();
//                 }
//               },
...
//                     ),
//                   ),
//                 if (isBlockedByMe == false && messageState.messages.isNotEmpty)
//                   PopupMenuItem(
//                     value: 'blockUser',
...
//         ),
//         backgroundColor: context.color.secondaryColor,
//         bottomNavigationBar: isBlockedByMe ?? false
//             ? Container(
...
//                 },
//                 child:
//                     BlocConsumer<LoadChatMessagesCubit, LoadChatMessagesState>(
//                   listener: (context, state) {
